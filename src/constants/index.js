...
export const EXPERIENCES = [
  {
    ...
    description: `Translated design concepts into interactive web interfaces.Ensured cross-browser compatibility and responsive design.Implemented JavaScript functionality for improved user interactions..`,
    technologies: ["Javascript", "Html", "Css", "Responsive"],
  },
  {
    year: "Januaery 2024 To April 2024",
    role: "java Developer,  Intern",
    company: "Xipra Technology",
    description: `Applied Java programming skills to web development projects.Collaborated with team members to design and implement web-based solutions.Gained practical experience in developing and maintaining Java-based web applications.Contributed to the development and enhancement of web features and functionalities.Learned and applied web development frameworks and technologies such as Spring, Spring Boot, and Servlets.`,
    technologies: ["java", "jsp", "SpringBoot", "mySQL"],
  },
